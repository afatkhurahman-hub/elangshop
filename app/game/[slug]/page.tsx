...
export default function DetailGamePage() {
  ...
  const currentItems = productsData["Game"]?.items || {};
    ...
    return (
      <main className="min-h-screen bg-[#070B14] text-white overflow-x-hidden">
        ...
        <div className="p-20 text-center text-white">
          ...
          <button onClick={() => router.push("/game")} className="mt-4 text-[#FACC15] font-bold hover:underline">
            Kembali ke Game
          </button>
        </div>
        <FaqAndFooter />
  ...
  // 🚀 SEKARANG GAMBARNYA DIAMBIL LEWAT HELPER FUNCTION BERDASARKAN FOUNDKEY ("Clash of Clans")
  const mockProduct = {
    title: foundKey,
    category: "Game", 
