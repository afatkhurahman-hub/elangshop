...
export default function DetailPremiumPage() {
  ...
  const currentItems = productsData["Premium"]?.items || {};
    ...
    return (
      <main className="min-h-screen bg-[#070B14] text-white overflow-x-hidden">
        ...
        <div className="p-20 text-center text-white">
          ...
          <button onClick={() => router.push("/premium")} className="mt-4 text-[#FACC15] font-bold hover:underline">
            Kembali ke Premium
          </button>
        </div>
        <FaqAndFooter />
  ...
  // 🚀 SEKARANG GAMBARNYA DIAMBIL LEWAT HELPER FUNCTION BERDASARKAN FOUNDKEY
  const mockProduct = {
    title: foundKey,
    category: "Premium", 
